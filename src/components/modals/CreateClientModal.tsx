...
export default function CreateClientModal({
  ...
  const [selectedRouter, setSelectedRouter] = useState<any | null>(null);
  ...
  useEffect(() => {
    ...
    client
      .get(`/infraestructura/naps?zona_id=${formData.zona_id}`)
  ...
  useEffect(() => {
    ...
    client
      .get(`/infraestructura/naps/${formData.caja_nap_id}/detalles`)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (activarAhora) {
        const resActivacion = await client.post(
