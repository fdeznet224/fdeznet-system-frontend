...
const FeatureCard = ({ icon: Icon, color, bg, border, title, desc }: FeatureCardProps) => (
...
const PricingCard = ({ name, price, period, clients, features, recommended, badgeText, link }: PricingCardProps) => (
